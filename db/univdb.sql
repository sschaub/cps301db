...
GRANT SELECT on offering TO mysql;
...
GRANT SELECT on student to mysql;
GRANT SELECT on offering to mysql;
GRANT SELECT on faculty to mysql;
GRANT SELECT on course to mysql;
GRANT SELECT on enrollment to mysql;
GRANT SELECT on club to mysql;
GRANT SELECT on stdclub TO mysql;
