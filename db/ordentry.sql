...
GRANT SELECT on customer to mysql;
GRANT SELECT on employee to mysql;
GRANT SELECT on product to mysql;
GRANT SELECT on ordertbl to mysql;
GRANT SELECT on ordline TO mysql;
